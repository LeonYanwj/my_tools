# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-08-14 09:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('securitydevice', '安全设备'), ('idcdevice', '机房设备'), ('accescories', '备件'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
                ...
                ('management_ip', models.GenericIPAddressField(blank=True, null=True, verbose_name='管理ip地址')),
                ...
                ('price', models.FloatField(blank=True, null=True, verbose_name='硬件价格')),
                ('tags', models.CharField(blank=True, max_length=128, null=True, verbose_name='标签')),
                ('status', models.SmallIntegerField(choices=[(0, '在线'), (1, '已下线'), (2, '故障'), (3, '备用'), (4, '位置')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(choices=[('auto', 'Auto'), ('menual', 'Manual')], default='auto', max_length=8)),
                ('model', models.CharField(blank=True, max_length=128, null=True, verbose_name='型号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(blank=True, max_length=64, null=True, unique=True, verbose_name='软件/系统版本')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='asset.Asset')),
            ],
            options={
                'verbose_name': '软件/系统',
        ...
        migrations.AddField(
            model_name='asset',
            name='manufactory',
            field=models.ForeignKey(blank=True, max_length=128, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.Manufactory', verbose_name='制造商'),
        ),
